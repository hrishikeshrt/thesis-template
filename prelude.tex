...
% DECLARATION
%
% \signaturefile{graphics/student_signature.png} % define full path to student's signature
% \signaturescale{0.75}  % define scale for student's signature
% \signaturetrue     % enable student's signature on declaration page
